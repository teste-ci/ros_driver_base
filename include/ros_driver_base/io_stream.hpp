#ifndef ROS_DRIVER_BASE_IOSTREAM_HH
#define ROS_DRIVER_BASE_IOSTREAM_HH
...
namespace ros_driver_base
{
    ...
    public:
        virtual ~IOStream();
        virtual void waitRead(ros::Duration const& timeout) = 0;
        virtual void waitWrite(ros::Duration const& timeout) = 0;
    ...
    public:
        ...
        virtual ~FDStream();
        virtual void waitRead(ros::Duration const& timeout);
        virtual void waitWrite(ros::Duration const& timeout);
