#ifndef ROS_DRIVER_BASE_GTEST_HPP
#define ROS_DRIVER_BASE_GTEST_HPP

#include <gtest/gtest.h>
#include <ros_driver_base/fixture.hpp>

#define ROS_DRIVER_BASE_MOCK() ros_driver_base::Fixture<fixture_driver_t>::GTestMockContext __context(this);
...
namespace ros_driver_base {
    ...
    public:
        ...
        void tearDown()
        {
            ...
            {
                ADD_FAILURE() << "ROS_DRIVER_BASE_MOCK Error: Test reached its end without satisfying all expecations.";
            }
        }
